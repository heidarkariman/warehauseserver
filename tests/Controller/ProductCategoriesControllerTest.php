...
class ProductCategoriesControllerTest extends WebTestCase
{
    ...
    private string $path = '/product/categories/';

    protected function setUp(): void
    {
        $this->client = static::createClient();
        $this->repository = static::getContainer()->get('doctrine')->getRepository(ProductCategories::class);
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            'product_category[product]' => 'Testing',
            'product_category[category]' => 'Testing',
        ]);

        self::assertResponseRedirects('/product/categories/');
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            'product_category[product]' => 'Something New',
            'product_category[category]' => 'Something New',
        ]);
